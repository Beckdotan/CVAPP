    ...
    <header className=" fixed top-0 w-full bg-darkerColor bg-opacity-70 backdrop-blur-md text-lightGray z-50 shadow-md shadow-darkBackground">
      <div className="flex justify-between items-center h-16 px-8">
        ...
        <div className=" hidden md:flex items-center justify-center">
          <a className=" text-cyanBlue border border-cyanBlue px-3 py-2 rounded-full text-center hover:bg-cyanBlue hover:text-darkBackground transition duration-300 ">
            Contact Me
          </a>
        </div>
